        ...
        >
                    ...
                    <Flex alignItems="center">
                      <Center>
                        ...
                        <a
                          className={styles.SocialIcon}
                          target="_blank"
                          href="https://www.linkedin.com/in/akshay-sadaphal-69b40b19b?"
                        >
                          {" "}
                    ...
                    <Flex mt={5}>
                      ...
                      <Center>
                        ...
                        <a
                          className={styles.SocialIcon}
                          target="_blank"
                          href="mailto:akshaysadaphal67@gmail.com"
                        >
                          {" "}
                          <Box className={styles.iconBox}>
                            <Flex justifyContent="center" alignItems="center">
                        ...
                        <a
                          className={styles.SocialIcon}
                          target="_blank"
                          href="https://api.whatsapp.com/send/?phone=918766776144&text=I%27m+interested+to+talk+with+you!&type=phone_number&app_absent=0"
                        >
                        <Box ml={10} className={styles.iconBox}>
                          <Flex justifyContent="center" alignItems="center">
                            <BsTelephoneFill
          ...
          <Box>
            <Text className={styles.texts} >
              Designed and Developed by AKSHAY SADAPHAL,© Copyright 2023. All rights
              reserved
            </Text>
          </Box>
        </Box>
